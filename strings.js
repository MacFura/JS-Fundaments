let first = 'Knowlage is power but enthusiasm pulls the switch';
let second = "Do or do not. There is no try.";
let third = '4,8,15,16,23,42';

//-----methodes of strings=========
// You can even call this methods on string literals
...
// let myStarstWith = second.startsWith('Do');
// console.log(myStarstWith);
